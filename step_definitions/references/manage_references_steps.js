...
Then(/^judicial office holder can be assigned to a hearing$/, function () {
    throw new Error('Not implemented yet');
});
...
Then(/^judicial office holder can't be assigned to a hearing$/, function () {
    throw new Error('Not implemented yet');
});
...
When(/^I add the Retirement Date which falls in\-between a multiple day hearing$/, function () {
    throw new Error('Not implemented yet');
});
